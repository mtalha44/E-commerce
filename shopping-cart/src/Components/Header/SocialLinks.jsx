import { ImGit, ImGithub, ImGoogle, ImLinkedin2, ImLocation2, ImPhone, ImPinterest2, ImTwitch, ImWhatsapp } from "react-icons/im";
...
export const Social = () => {
    ...
    return (
        <div className="social-tab">
            ...
            <div className="flex-row left-social-tab">
